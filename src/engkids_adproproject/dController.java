...
public class dController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
         String voice = "D:\\programming\\EngKids_AdProProject\\src\\media\\D.mp3";     
    ...
    @FXML
    private void play_d_sound(MouseEvent event) {
    ...
    @FXML
    private void play_dog_sound(MouseEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader();
           loader.setLocation(getClass().getResource("F.fxml"));
    ...
    void rec0En(MouseEvent event) {
        ...
        d_sound.setFitWidth(115);
        d_sound.setFitHeight(135);
    ...
    void rec0Ex(MouseEvent event) {
        ...
        d_sound.setFitWidth(110);
        d_sound.setFitHeight(130);
