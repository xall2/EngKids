 ...
 * @author mone-
 */
public class BController1 implements Initializable {
    private Label label;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String voice = "D:\\programming\\EngKids_AdProProject\\src\\media\\B.mp3";     
    ...
    @FXML
    private void play_banana_sound(MouseEvent event) throws IOException {
       ...
       @FXML
    private void play_B_sound(MouseEvent event) {
         String voice = "D:\\programming\\EngKids_AdProProject\\src\\media\\B.mp3";     
        Media sound = new Media(new File(voice).toURI().toString());
        MediaPlayer mediaPlayer = new MediaPlayer(sound);
        mediaPlayer.play();
   ...
   @FXML
    ...
    void rec0En(MouseEvent event) {
        ...
        b_sound.setFitHeight(156);
        b_sound.setFitWidth(135);
    ...
    void rec0Ex(MouseEvent event) {
        ...
        b_sound.setFitHeight(151);
        b_sound.setFitWidth(130);
