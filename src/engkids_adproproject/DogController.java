...
/*******************************************************************/
    ...
    private void play_wrong_sound(MouseEvent event) {
        ...
        if(sucssec <=3){
        String v = "D:\\programming\\EngKids_AdProProject\\src\\media\\Wrong.mp3";     
        Media s = new Media(new File(v).toURI().toString());
        MediaPlayer mp = new MediaPlayer(s);
        mp.play();
        }
        else{
        String vo = "D:\\programming\\EngKids_AdProProject\\src\\media\\yaaay.mp3";     
        Media so = new Media(new File(voice).toURI().toString());
        MediaPlayer me = new MediaPlayer(so);
        me.play();  }
        
         
        lbResult.setText("Your result: "+sucssec+"/5");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        String voice = "D:\\programming\\EngKids_AdProProject\\src\\media\\dog.mp3";     
        Media sound = new Media(new File(voice).toURI().toString());
        MediaPlayer mediaPlayer = new MediaPlayer(sound);
        mediaPlayer.play();
         }
 ...
 @FXML
    ...
    @FXML
    void closeGame(MouseEvent event) throws IOException {
