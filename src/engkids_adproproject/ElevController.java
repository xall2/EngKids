 ...
 * @author alaas
 */
public class ElevController implements Initializable {
private Stage stage;
    private Scene scene;
    private Parent root;
...
/*******************************************************************/
    ...
    private void play_wrong_sound(MouseEvent event) throws IOException {
       String voice = "D:\\programming\\EngKids_AdProProject\\src\\media\\lose2.mp3";     
        ...
        /****/
           FXMLLoader loader = new FXMLLoader();
           loader.setLocation(getClass().getResource("sheep.fxml"));
           Parent num1234 = loader.load();
           Scene scene = new Scene(num1234);
           
           SheepController controller= loader.getController();
           controller.sucssec=sucssec;
           controller.setUserName(username.getText());/****DataBase*****/
           /***/
           Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(scene);
        window.show();
 ...
 @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        String voice = "D:\\programming\\EngKids_AdProProject\\src\\media\\elephent.mp3";     
        Media sound = new Media(new File(voice).toURI().toString());
        MediaPlayer mediaPlayer = new MediaPlayer(sound);
        mediaPlayer.play();
    }  
